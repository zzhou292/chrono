...
class SYN_API SynWheeledVehicleDescriptionMessage : public SynMessage {
  public:
    ...
    ///@brief Set the collision files from a JSON specification file
    ///
    ///@param filename the json specification file
    void SetCollisionFilesFromJSON(const std::string& filename);
    ...
    ///@brief Set the collision files used for zombie collision
    ///
    ///@param chassis_col_file filename for the chassis collision visualization
    void SetCollisionFiles(const std::string& chassis_col_file);
    ...
    std::string chassis_col_file = "";  ///< file name for chassis collision visualization
