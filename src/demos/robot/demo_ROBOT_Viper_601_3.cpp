...
int main(int argc, char* argv[]) {
    ...
    std::string path_file = GetChronoDataFile("rover_obs_3.txt");
    ...
    std::vector<ChVector<>> rock_pos = {
        ChVector<>(5.0, -1.4, -0.1),  ChVector<>(0.2, 4.8, -0.1),  //
        ChVector<>(0.0, 0.0, -0.1),   ChVector<>(6.4, 4.5, -0.1),  //
        ChVector<>(-3.8, -2.0, -0.1), ChVector<>(3.5, 3.0, -0.1),  //
        ChVector<>(-2.8, 4.0, -0.1),  ChVector<>(-8.0, 8, -0.1),   //
        ChVector<>(2.8, -3.7, -0.1),  ChVector<>(-7.2, 2.3, -0.1)  //
    };
