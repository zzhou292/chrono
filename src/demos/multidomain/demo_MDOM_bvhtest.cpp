...
int main(int argc, char* argv[]) {
    ...
    std::vector<AABB> test_aabbs = {
        {{0, 0, 0}, {1, 1, 1}},  // Object 0
        {{2, 2, 2}, {3, 3, 3}},  // Object 1
        {{4, 4, 4}, {5, 5, 5}}   // Object 2
    };
    ...
    if (groups.size() != 2 || groups[0].size() + groups[1].size() != 3) {
    ...
    // Simulate movement
    test_aabbs[0] = {{0.1, 0.1, 0.1}, {0.9, 0.9, 0.9}};
    test_aabbs[2] = {{4.1, 4.1, 4.1}, {4.9, 4.9, 4.9}};
