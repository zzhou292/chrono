...
int main(int argc, char* argv[]) {
    ...
    ChDomainBuilderSlices domain_builder(
        ...
        ChAxis::Z,                            // axis about whom one needs the space slicing
    ...
    explicit_timestepper->SetConstraintsAsPenaltyON(
    ...
    for (int i = 0; i < 5000; ++i) {
        std::cout << "rank " << domain_manager.GetMPIrank() << " time step " << i << std::endl;
