...
int main(int argc, char* argv[]) {
    ...
    auto lidar_baselink_tf_handler = chrono_types::make_shared<ChROSTFHandler>(
        lidar_baselink_tf_rate, lidar, cobra.GetChassis()->GetBody(), lidar_baselink_tf_topic_name);
