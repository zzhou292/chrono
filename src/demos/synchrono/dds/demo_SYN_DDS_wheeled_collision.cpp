...
int main(int argc, char* argv[]) {
    ...
    double cam_distance;
    std::string vehicle_filename, chassis_col_filename, engine_filename, transmission_filename, tire_filename,
        zombie_filename;
    GetVehicleModelFiles((VehicleType)cli.GetAsType<int>("vehicle"), vehicle_filename, chassis_col_filename,
                         engine_filename, transmission_filename, tire_filename, zombie_filename, cam_distance);
...
void GetVehicleModelFiles(VehicleType type,
    ...
    switch (type) {
        case VehicleType::SEDAN:
            ...
            chassis_col = vehicle::GetDataFile("sedan/sedan_chassis_col.obj");
            zombie = synchrono::GetDataFile("vehicle/col/Sedan.json");
            cam_distance = 6.0;
            break;
        case VehicleType::HMMWV:
            ...
            chassis_col = vehicle::GetDataFile("hmmwv/hmmwv_chassis_col.obj");
            zombie = synchrono::GetDataFile("vehicle/col/HMMWV.json");
            cam_distance = 6.0;
            break;
        case VehicleType::UAZ:
            ...
            chassis_col = vehicle::GetDataFile("uaz/uazbus_chassis_col.obj");
            zombie = synchrono::GetDataFile("vehicle/col/UAZBUS.json");
            cam_distance = 6.0;
            break;
        case VehicleType::CITYBUS:
            ...
            chassis_col = vehicle::GetDataFile("citybus/CityBus_Col.obj");
            zombie = synchrono::GetDataFile("vehicle/col/CityBus.json");
            cam_distance = 14.0;
            break;
        case VehicleType::MAN:
            ...
            chassis_col = vehicle::GetDataFile("MAN_Kat1/meshes/MAN_10t_chassis_col.obj");
            zombie = synchrono::GetDataFile("vehicle/col/MAN_8WD.json");
            cam_distance = 12.0;
            break;
    }
}