...
int main(int argc, char* argv[]) {
    ...
    std::vector<ChVector3d> rock_positions = {ChVector3d(0.1, 0.2, 0.95), ChVector3d(0.3, 0.4, 0.85),
                                              ChVector3d(0.5, 0.6, 1.05)};
    std::vector<ChQuaternion<>> rock_rotations = {QuatFromAngleX(CH_PI_4), QuatFromAngleX(CH_PI_4),
                                                  QuatFromAngleZ(CH_PI_2)};
    std::vector<std::string> rock_obj_paths = {GetChronoDataFile("obj-collection/sphere/bunny.obj"),
                                               GetChronoDataFile("obj-collection/sphere/bunny.obj"),
                                               GetChronoDataFile("obj-collection/sphere/bunny.obj")};
